// default mock data (used only if server doesn't provide products)
const MOCK_PRODUCTS = [
...
let productsData = (window && window.__ADMIN_PRODUCTS__ && Array.isArray(window.__ADMIN_PRODUCTS__) && window.__ADMIN_PRODUCTS__.length > 0)
